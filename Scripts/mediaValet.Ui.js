...
+function ($, source, mvCore, mvAppSdkCore) {
    ...
    var TemplateModel = {
        ...
        */
        ...
        SignUpTemplate: function (options) {
            ...
            var ui = '<div class="mainparentlogindiv" ><div class="logo"><div id="logdiv" style="float: left;line-height: 70px;cursor:pointer"><img id="logoimgid" src="images/mv-logo.png" height="32px" width="100px" alt="MediaValet" style="margin-top: 16px;margin-left: 25px;" /></div><div id="createlibrarysigninbtn" style="cursor: pointer;line-height: 70px;vertical-align: middle; margin-left: 54px;"><img style="display: inline;  height: 20px; width: 20px; LINE-HEIGHT: 70px;vertical-align: middle; margin-left: 100px;" src="images/signup.png" alt="MediaValet"  /><p style=" color: #000;display: inline;font-size: 11px;line-height: 18px;">Login</p></div></div>' +
            '<div class="login-comment"></div>' +
         '<div class="signup-block" style="border:1px solid #ccc;">' +
                                '<p style="color:#3a3636;font-size:18px;margin-left:40%;margin-top:-5px">Enter..</p>' +
                                '<span style="color:#5a5757;font-size:12px;margin-left:5px;">Your full name<span>' +
                                '<input type="text" value=""  id="usernametxt" />' + '<span style="color:#5a5757;font-size:12px;margin-left:5px;">Your company name<span>' +
                                '<input type="text" value=""  id="usercompanynametxt" />' + '<span style="color:#5a5757;font-size:12px;margin-left:5px;">Your company email<span>' +
                                '<input type="text" value=""  id="usercompanyemailtxt" />' +
                                '<span style="color:#5a5757;font-size:12px;margin-left:5px;">Your company phone number </span><input type="text" value=""  id="usercompanyphonetxt" />' +
        ...
        LoginOfficeTemplate: function (options) {
          ...
          '<div class="login-block" style="border:1px solid #ccc;">' +
                '<p style="color:#000;font-size:12px;margin-left:10px"></p>' +
                '<span style="color:#3a3636;font-size:12px;margin-left:5px;color:#8a8686;font-family:Tahoma, Geneva, Arial, sans-serif;font-weight:medium;">Username<span><input type="text" id="urltxt" placeholder="Enter URL"  class="textbox" style="display:none" />' +
        ...
        LoginTemplate: function (options) {
            ...
            var ui = '<div class="logo"><img src="images/mv-logo.png" alt="MediaValet" /></div>' +
                    ...
                    '<div class="login-block">' +
                            ...
                            '<input type="button" value="Submit" id="mv-login" class="loginbutton" /><div id="microsoftlogodiv" style="margin-left:30%;cursor:pointer;display:none;"><img src="./logo/mslogo.jpg" height="100px" width="100px" /></div>' +
            ...
            if (options.setting != null || options.setting != undefined) {
                ...
                '</ul></div></div><input class="officesearchbtn" type="text" placeholder="Search all asset" id="searchtxt" /><div id="searchbtn" class="search"><img src="images/search-icon.png" /></div><div class="officemenu1"><ol id="officemenuol"><li id="liEditMetaData" style="display:none">Edit Attributes</li><li id="liSortbyName">Sort by Name<span id="sortnamespan"></span></li><li id="liSortbyDate" >Sort by Date<span id="sortdatespan"> </span></li><li id="liAbout">About</li><li id="liLogout">Logout</li></ol></div><div class="menu2"><ol><li id="liSmall">Small</li><li id="liMedium">Medium</li><li id="liLarge">Large</li></ol></div><div class="menu3"><ol><li>1st image</li><li>2nd image</li><li>3rd image</li><li>4th image</li></ol></div></div><div class="clear"></div><div id="errormessagediv" class="alert-box error" ></div><div id="infomessagediv" class="infoalert-box info" ></div><div class="medialibrary"><div class="clear"></div><p id="mediavaletlibraryparaid"></p><div class="contentBox" id="bindsearchdatadiv" ></div></div></div> </div><div id="pptexcelmessagediv"></div>';
                    ...
                    searchpanels = '<div class="mainlogindiv"><div class="medialibraryMain" id="mycontainertestid"><div class="searchBox">' +
                       ...
                       '<div id="cbp-hrmenu" class="cbp-hrmenu" style="width:29px;"><ul><li class=""><button class="officefilter" id="btnFilter" href="#modalFilter"><img src="images/filter.png" id="imgFilter" /></button>' +
                                ...
                                $(alllinks).each(function (k, medialinks) {
                                    ...
                                    if (assetOfflineList.indexOf(assetid) < 0) {    
                                        $(medialinks.media).each(function (index, links) {
                                            ...
                                            if (metacount != 0) {
                                                flydowntabletr = Events.MetaDataBindWithFlydown(assetid, token, appsname, metacount, alllinks);
                                            }
                                            ...
                                            $('#bindsearchdatadiv').bind().on("click", 'div[id="' + largediv + '"]', function () {
                                                ...
                                                if (appsname.toLowerCase() == "outlook" || appsname.toLowerCase() == "eloqua" || appsname.toLowerCase() == 'office' || appsname.toLowerCase() == "drupal" || appsname.toLowerCase() == "hootsuite") {
                                                    ...
                                                    if ($('#' + playerbtn).html() != undefined) {
                                                        if (defaultsettings.apps != "outlook" && defaultsettings.apps != "office") {
                                                        ...
                                                        if (($thisCell).hasClass('is-expanded')) {
                                                            ...
                                                            if (element[0] != undefined && element[0].className == "thumbsplaybutton") {
                                                                ...
                                                                if (defaultsettings.apps == "outlook" || defaultsettings.apps == "office") {
                                                                    ...
                                                                    Events.AzureHtmlPlayerSettings(azhidden, playerbtn);

                                                                } else {
                                                                    Events.AzureFlashPlayerSettings(azhidden, playerbtn);
    ...
    */
    var Events = (function () {
        return {
            ...
            BindLoginEvent: function (option) {
                ...
                $('#mv-microsoft-login').on({
                    click: function () {
                        var currenturl = window.location.href;
                        var stateid = mvCore.newGuid();
                        //window.location.href = "https://identity-il.mediavalet.net/login/signin?orgUnitId=b3062136-326b-405f-aa41-dcd216ac079b&returnUrl=https://videoneticsvms.cloudapp.net/mediavalet/office.html&state=" + stateid;
                        //window.location.href = "https://identity-il.mediavalet.net/login/signin?orgUnitId=b3062136-326b-405f-aa41-dcd216ac079b&state=" + stateid + "&returnUrl=https://identity-il.mediavalet.net/token?grant_type=authorization_code&client_id=b3062136-326b-405f-aa41-dcd216ac079b";
                        window.location.href = "https://identity-il.mediavalet.net/login/signin?orgUnitId=b3062136-326b-405f-aa41-dcd216ac079b&returnUrl=" + currenturl + "&state=" + stateid + "&tenantId=c2ccdaa6-99e8-4789-a22e-a634d94b93e4"; //http:%2F%2Flocalhost:33738%2Foffice.html https:%2F%2Fdemoappsource.mediavalet.com%2F&state=" + stateid; 
                        //window.location.href = "https://identity-il.mediavalet.net/login/signin?orgUnitId=2adaa2ba-4e7e-44c1-b5b8-078feff2b165&returnUrl=http:%2F%2Flocalhost:33738%2Foffice.html%2F&state=" + stateid;    //https:%2F%2Fdemoappsource.mediavalet.com%2F&state=" + stateid;
                    }
                });
            ...
            /** Validates login with Azure Directory*/
            ValidateADLogin: function (option, result, event) {
                if (result.access_token != "" && result.access_token != undefined ) {
                    $('#errormessagediv').css('display', 'none');
                    $('#infomessagediv').css('display', 'none');
                    mvCore.SetCookies('cookieurlapi', 'https://api-usil.mediavalet.net', 7);
                    Events.SetLoginToken(option, result.access_token, 7);
                    ...
                    if (tokens != undefined) {
                        ...
                        //Start-Getting user authentication type
                        ...
                        $.when(data2).done(function (uadata) {
                            if (uadata.errormessage != null) {
                                ...
                                if (uadata.defaultGroup != null) { //if suceess
                                    ...
                                    mvCore.SetCookies('cookiedomainemail', uadata.data.payload.emailAddress, 7);
                                    mvCore.SetCookies('coookiedomainname', uadata.data.payload.emailAddress.split('@')[1], 7);
                                    var username = mvCore.GetCookies('cookiedomainemail');//
                                    var domainname = mvCore.GetCookies('coookiedomainname');//
                                    Events.LoadEventGetUserCategories(mvCore.GetCookies('cookiesclientid'), domainname, username, option.apps);
                        ...
                        if (option.instrumentationKey != undefined) {
                            mvAppSdkCore.ApplicationInsights(option.instrumentationKey);
                    ...
                    //Model.HideLoader();
                    //$('#errormessagediv').css('display', 'block');
                    //$('#errormessagediv').html('Sorry, the azure credentials you entered does not match any user in our system');
                    //event.preventDefault();
                    //window.location.href = window.location.href.split('?error')[0];
            ...
            ValidateLogin: function (option) {
                ...
                var checkusername = 'correct', appsname = '';

                if (option.apps != undefined) {
                    appsname = option.apps;
                }
                //Making Pattern here for checking user name if it looks like username@mywebsite.com
                var pattern = /^([a-z\d!#$%&'*+\-\/=?^_`{|}~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+(\.[a-z\d!#$%&'*+\-\/=?^_`{|}~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+)*|"((([ \t]*\r\n)?[ \t]+)?([\x01-\x08\x0b\x0c\x0e-\x1f\x7f\x21\x23-\x5b\x5d-\x7e\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|\\[\x01-\x09\x0b\x0c\x0d-\x7f\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))*(([ \t]*\r\n)?[ \t]+)?")@(([a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|[a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF][a-z\d\-._~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]*[a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])\.)+([a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|[a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF][a-z\d\-._~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]*[a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])\.?$/i;
                var checkusername = '',mediavaletusername='',mediavaletpassword='';
                var domainnametosend = '', username = '';
                if ($('#useremailtxt').val() != undefined) {
                    mediavaletusername = $('#useremailtxt').val().trim();
                } else {
                    mediavaletusername = option.username;
                }
                if ($('#passwordtxt').val() != undefined) {
                    mediavaletpassword = $('#passwordtxt').val();
                } else {
                    mediavaletpassword = option.password;
                }
                var index = mediavaletusername.indexOf('@');
                var index2 = mediavaletusername.indexOf(String.fromCharCode(92));
                var index3 = mediavaletusername.indexOf(String.fromCharCode(47));
                if (index3 < 0) {

                    if (index >= 0 && index2 < 0) {
                        if (pattern.test(mediavaletusername)) {
                            checkusername = 'correct';
                            domainnametosend = mediavaletusername;
                            username = mediavaletusername;
                        } else {
                            checkusername == "";
                        }
                    } else if (index2 >= 0) {
                        domainnametosend = mediavaletusername.split(String.fromCharCode(92));
                    ...
                    } else if (index < 0 && index2 < 3 && mediavaletusername != '') {
                        username = mediavaletusername;
                        domainnametosend = mediavaletusername;
                        checkusername = 'correct';
                    } else {
                ...
                if (mediavaletusername != '' && mediavaletpassword != '') {
                    if (checkusername == 'correct') {
                        urlmappingresult = mvCore.urlmapping(domainnametosend, appsname);//$('#useremailtxt').val().trim()); //, option.apps (new code)
                            ...
                            if (res.errormessage == null) {
                                if (res.data.ApiUrl.toLowerCase() != "domain name could not be resolved") {
                                    $(res).each(function (inde, apidata) {
                                        ...
                                        var autdata = mvCore.authentication(username, mediavaletpassword);
            ...
            */
            LoadEventGetUserCategories: function (orgunitid, domain, email, appname) {
                var data3 = mvCore.GetCategoriesForUser(orgunitid, appname, email);    //domain,
                ...
                $(window).click(function (event) {
                    if (defaultsettings.apps != null) {
                        ...
                        if (appsname.toLowerCase() == "office" || appsname.toLowerCase() == "drupal" || appsname.toLowerCase() == "default" || appsname.toLowerCase() == "eloqua" || appsname.toLowerCase() == "outlook" || appsname.toLowerCase() == "mobileapp") {
                            ...
                            if (getid != 'imgFilter' && (target.name != "RatingCheckbox" && target.name != "AssetTypeCheckbox" && target.name != "StatusCheckbox" && target.name!="")) {
                                $('#modalFilter').hide();
                            }
            ...
            */
            ...
            /**Function AzureFlashPlayerSettings
            *@param azhidden it s hidden tag id 
            *@param playerbtn it s player button id
            */
            AzureFlashPlayerSettings: function (azhidden, playerbtn) {
                var myOptions = {
                ...
                $('#' + elementid).click(function (event) {
                    ...
                    if (assettypes != "video" && assettypes != "audio") {
                        ...
                        if (defaultsettings.apps == "outlook") {
                            ...
                            if (assettypes == "file") {
                                mvAppSdkCore.InsertOfficeVideoAudio(asseturl, assetname, spanid, assetid, thumbsimage, assettypes);
                            } else if (assettypes == "image") {
                                mvAppSdkCore.InsertAsset(asseturl, assetname, spanid, assetid, thumbsimage, assettypes);
                            }
                        }
                        if (assettypes == "video" || assettypes == "audio") {
            ...
            CreateLibraryEvent: function (option) {
                ...
                $('#createlibrarybtn').click(function () {
                    ...
                    $('#logoimgid').off('click');
                    $('#logoimgid').click(function () {
                        console.log('test message')
                        Events.CreateLibraryEvent(option);
                    });
                });
                $('#createlibrarysigninbtn').off("click");
        ...
        OfficeSingIn: function (options) {
            ...
            $('#logoimgid').click(function () {
                console.log('test message')
                Events.CreateLibraryEvent(options);
            });
    ...
    MetaDataBindWithFlydown: function (assetid, token, appsname, count, data) {

        var check = 0;
        var tablerow = '', dateformat = "";
        $.when(data).done(function (data) {
            $(data.attributes).each(function (index, obj) {
                for (var i = 0; i < globalvarmedataidlist.length; i++) {
                    if (obj[globalvarmedataidlist[i]] != undefined) {

                        if (globalvarmetadatalist[i].indexOf('date') >= 0) {
                            if (obj[globalvarmedataidlist[i]] != "") {
    ...
    AzureADOAuth: function () {
        $('#msofficelogodiv').off("click");
        $('#msofficelogodiv').click(function () {
            var tenantid = '', adclientid = '', adredirecturi = '', nonce = '', state = '';
            var adsetting = mvCore.ADSettings();
            $.when(adsetting).done(function (data) {
                $(data).each(function (ind, obj) {
                    adclientid = obj.clientid;
                    tenantid = obj.tenantid;
                    adredirecturi = obj.redircturi;
                    nonce = obj.nonce;
                    state = obj.state;
                });
                var windowsurl = 'https://login.microsoftonline.com/' + tenantid + '/oauth2/authorize?response_type=id_token&client_id=' + adclientid + '&redirect_uri=' + adredirecturi + '&state=' + state + '&x-client-SKU=Js&x-client-Ver=1.0.0&nonce=' + nonce;
...
$.fn.LoginUI = function (options) {
    try {
        ...
        */
        ...
        var windowsurl = window.location.href;// = windowsurl;
        //var tokenindex = windowsurl.indexOf('token');
        //var codeindex = windowsurl.indexOf('error');
        var tempvalue = false;
        if (windowsurl.indexOf('?token') == -1 && windowsurl.indexOf('?code') == -1 && windowsurl.indexOf('?error') == -1 && tempvalue == false) {
            if (cookiesvalue == null || cookiesvalue == undefined) {
                ...
                //Changing defaultsettings.firstpage value to login if aderror is there in windowsurl
                if (windowsurl.indexOf('?aderror') != -1) {
                    defaultsettings.firstpage = 'login';
                }
                ...
                //setting error message for AD login error
                //if (windowsurl.indexOf('?aderror') != -1) {
        ...
        else if (windowsurl.indexOf('?token') == -1 && (windowsurl.indexOf('?code') != -1 || windowsurl.indexOf('?error') != -1)) {
            var defaults = {
                customText: 'Welcome',
                redirect: '',
                containerid: containerid,
            ...
            var t1 = ""; var t2 = ""; var adToken = "";
            if (browserUrl.indexOf('code=') > -1) {
                t1 = browserUrl.split("code=");
                t2 = t1[1].split("&state");
                adToken = t2[0];
            }
            else if (browserUrl.indexOf('error') > -1) {
                adToken = "";
            }
            $.ajax({
                type: "POST",
                url: "https://identity-il.mediavalet.net/token",
                data: { grant_type: "authorization_code", code: adToken, client_id: "b3062136-326b-405f-aa41-dcd216ac079b" },
                success: function (result) {
                    console.log(result);
                    Events.ValidateADLogin(defaultsettings, result);
                    window.location.href = windowsurl.split('?code')[0];
                    //mvCore.SetCookies('sessionazureadauth', '', 0);
                },
                error: function (errordata) {
                    //Events.ValidateADLogin(defaultsettings, '', event);
                    //window.location.href = windowsurl.split('?error')[0];
                    //var html = TemplateModel.LoginOfficeTemplate(settings);
                    //$(containerid).html(html);
                    ...
                    //return false;
                   // mvCore.SetCookies('sessionazureadauth', 'Yes', 7);
                    //event.stopPropagation();
                    var newurl = windowsurl.split('?error')[0];
                    window.location.href = newurl + '?aderror=No consent granted by Active Directory Administrator';
                }
            });
        }
            ...
            var defaults = {
                ...
                apps: '',
                mediavaleturl: 'http://www.mediavalet.com/',
                username: 'philippeadmin@mediavalet.net',
                password: '1234test!',
                view: {
                    recentview: true,
                    mostvisited: false
            ...
            var settings = $.extend({}, defaults, options);
            defaultsettings = settings;
            Events.ValidateLogin(defaultsettings);
        }
    } catch (e) {
        $('#errormessagediv').css('display', 'block');
        $('#errormessagediv').html(e.message);
...
$.fn.SearchUI = function (options) {
    ...
    // if (test.indexOf('powerpointupload')==-1) {
    globalvarmedataidlist = [];
    globalvarmetadatalist = [];
    /*Browser Name */
    ...
    if (defaultsettings.instrumentationKey != undefined) {
        mvAppSdkCore.ApplicationInsights(defaultsettings.instrumentationKey);
        mvAppSdkCore.ApplicationInsightsTracking("login");
                                                    }
    if (token != null || token != undefined) {
        try {
