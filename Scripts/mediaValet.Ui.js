...
+function ($, source, mvCore) {
    ...
    var TemplateModel = {
        ...
        SearchTemplate: function (options) {
            ...
            defaults = options;
            return '<div class="medialibraryMain"><div class="searchBox"> <input type="search"  placeholder="Search.." id="searchtxt" /><button class="search" id="searchbtn"><img src="images/search-icon.png"></button><button class="dots" id="menubtn" href="#modal"><img src="images/dots.png"></button><button class="settings" id="searchsettingsbtn"><img src="images/setting.png"></button><button class="edit"><img src="images/edit.png"></button><div class="menu1"><ol><li>Sort by Name</li><li>Sort by Date</li><li>About</li><li>Logout</li></ol></div><div class="menu2"><ol><li>Default</li><li>Small</li><li>Medium</li><li>Large</li></ol></div><div class="menu3"><ol><li>3.Menu1</li><li>3.Menu2</li><li>3.Menu3</li><li>3.Menu4</li></ol></div></div><div class="clear"></div><div class="medialibrary"><div class="clear"></div><p id="mediavaletlibraryparaid"></p><div class="contentBox" id="bindsearchdatadiv" ></div></div></div>';
        },
        ...
        return {
            BindLoginEvent: function (option) {
                ...
                $('#mv-login').bind({
                    click: function () {
                        ...
                        // Checking Validation for given credential
                        $('#errormessage').html('');
                        /*
            ...
            RecentUploadedMoreEvent: function (option) {
                $('#recentlyviewedmorebtn').bind({
                        click: function() {
                            //alert("recentlyviewedmorebtn");
                            $('#mediavaletlibraryparaid').html('<span><button id="mediavaletlibraryid" style="background: none !important; font: inherit; margin: 10px; padding: 0px !important; border: currentColor; border-image: none; color: rgb(39, 38, 17); cursor: pointer; font-size-adjust: inherit; font-stretch: inherit;">Media Library</button><img src="images/arrow_right.png" /> <label>Recently Uploaded</label></span>');
                            ...
                            SearchingScreen.ImageLoading(recentlyviwed, 0);
                            ...
                            $('#bindsearchdatadiv').on('scroll', function () {
                                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
                                    ...
                                    SearchingScreen.ImageLoading(recentlyviwed, recentlyviewedoffset);
            ...
            MostViewedMoreEvent: function (option) {
                $('#mostviewedmorebtn').bind({
                    click: function() {
                        ...
                        SearchingScreen.ImageLoading(mostviwed, 0);
                        ...
                        $('#bindsearchdatadiv').on('scroll', function () {
                            if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
                                ...
                                SearchingScreen.ImageLoading(mostviwed, mostviewedoffset);
    ...
    $.fn.SearchUI = function (options) {
        if (mvCore.GetCookies('cookiestkn') != null || mvCore.GetCookies('cookiestkn') != undefined) {
            ...
            var settings = $.extend({}, defaults, options);
            $('#mvapp-container').html(Model.SearchPanel(settings));
            Events.SearchingEvent();
