    ...
    var mediaValetOffice = function () {
        ...
        */
        mediaValetOffice.prototype.InsertAsset = function (imageurl, imagename, spanid, assetid, thumbs, assettype) {
            mediaValetOffice.prototype.PowerPointUpload();
            try {
           ...
           // $('#errormessagediv').css('display', 'block');
           // $('#errormessagediv').html(window.location.search);
        }
        ...
        */
        ...
        mediaValetOffice.prototype.PowerPointUpload = function () {
            Office.context.document.getFilePropertiesAsync(function (asyncResult) {
                var fileUrl = asyncResult.value.url;
                setTimeout(function () {
                    $('#errormessagediv').css('display', 'block');
                    $('#errormessagediv').html(fileUrl);
                }, 7000);
